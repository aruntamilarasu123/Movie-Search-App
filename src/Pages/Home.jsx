...
function Home() {
  return (
    <div className="text-[#ffffff] px-20 hero-section flex items-center">
      <div className="w-1/2 flex flex-col justify-center gap-8">
        <h1 className="poppins-extrabold tracking-wide text-4xl">Free Movies to Watch, Anytime Anywhere.</h1>
        <p className="text-3xl">The search is over! Let Plex help you find the perfect movie to watch tonight for free.</p>
